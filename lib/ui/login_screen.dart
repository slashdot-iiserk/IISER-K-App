...
import 'package:iiserk_app/widgets/progress_dialog.dart';
import 'package:iiserk_app/helpers/app_futures.dart';
import 'package:iiserk_app/models/base/EventObject.dart';
import 'package:iiserk_app/ui/start_screen.dart';
import 'package:iiserk_app/ui/register_screen.dart';
...
class LoginScreenState extends State<LoginScreen> {
  ...
  ProgressDialog progressDialog = ProgressDialog.getProgressDialog(
      ProgressDialogTitles.login_progress_authenticating);
  ...
  void _getUserToken(String username, String password) async {
    ...
    switch (eventObject.id) {
      case EventConstants.LOGIN_USER_SUCCESSFUL:
        {
          setState(() {
            userToken = eventObject.object.toString();
