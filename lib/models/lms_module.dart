class LmsModule {
  ...
  /*LmsModule(this._id,  this._shortname,  this._categoryid,  this._categorysortorder,  this._fullname,  this._displayname,  this._idnumber,  this._summary,  this._summaryformat,  
  ...
  LmsModule(this._id, this._categoryid, this._shortname, this._fullname,
      this._summary, this._format);
  ...
  LmsModule.fromMapObject(Map<String, dynamic> map) {
    this._id = map['id'];
