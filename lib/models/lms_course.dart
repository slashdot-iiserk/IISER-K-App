class LmsCourse {
  ...
  /*LmsCourse(this._id,  this._shortname,  this._categoryid,  this._categorysortorder,  this._fullname,  this._displayname,  this._idnumber,  this._summary,  this._summaryformat,  
  ...
  LmsCourse(this._id, this._categoryid, this._shortname, this._fullname,
  ...
  LmsCourse.fromMapObject(Map<String, dynamic> map) {
    this._id = map['id'];
